...
def get_docs(path='/home/zy/data2/yyr/codes/kg4proj-rec/OpenKS-Expert-Rec/data/datav1/entities_paper.pkl'):
...
if first_run:
    ...
    save_to_disk(docs, './paper_docs.pkl')

if first_run is False:
    print('first_run is False')
    
docs = load_from_disk('./paper_docs.pkl')
stopwords = set()
...
if predict:
    # inference
    path = './paper_saved/lda_passes40.model'
    ...
    save_to_disk(project2topic, './paper2topic.pkl')
    with open('./paper_topics.txt', 'w') as f:
...
for i in range(1,11):
    ...
    print(f'./paper_saved/lda_passes{passes}.model')
    model.save(f'./paper_saved/lda_passes{passes}.model')
